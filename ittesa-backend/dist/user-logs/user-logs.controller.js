...
let UserLogsController = class UserLogsController {
    ...
    async findAll(userId, action, module, startDate, endDate) {
...
], UserLogsController.prototype, "findAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserLogsController.prototype, "export", null);
exports.UserLogsController = UserLogsController = __decorate([
